...
class JdPay extends AbstractGateway
{
    ...
    public function orderPay(array $body)
    {
        try {
            ...
            $this->errTraceName = 'JdPay--orderPay';
    ...
    public function orderCreate(array $body)
    {
        try {
            ...
            $this->errTraceName = 'JdPay--orderCreate';
    ...
    public function orderRefund(array $body)
    {
        try {
            ...
            $this->errTraceName = 'JdPay--orderRefund';
    ...
    public function orderQuery(array $body)
    {
        try {
            ...
            $this->errTraceName = 'JdPay--orderQuery';
    ...
    public function orderMcAutoNotice(array $body)
    {
        try {
            ...
            $this->errTraceName = 'JdPay--orderMcAutoNotice';
    ...
    public function clearfileDownload(array $body)
    {
        try {
            ...
            $this->errTraceName = 'JdPay--clearfileDownload';
