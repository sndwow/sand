 ...
 * H5 一键快捷
 */
class H5fastPay extends AbstractGateway
{
    public function orderCreate(array $params)
    {
        try {

            return 'https://sandcash.mixienet.com.cn/pay/h5/fastpayment?' . http_build_query($this->h5struct($params)); // 返回支付url

        }catch (\Throwable $e) {
            $newException = $e instanceof SandException ? $e : new BusinessException(
                json_encode(['H5一键快捷','message' => $e->getMessage(),'file' => $e->getFile(),'line' => $e->getLine()]),
                $this,
                $e
            );
            throw $newException;
    ...
    public function orderRefund(array $body)
    {
        try {
            ...
            $this->errTraceName = 'H5fastPay--orderRefund';
    ...
    public function orderQuery(array $body)
    {
        try {
            ...
            $this->errTraceName = 'H5fastPay--orderQuery';
    ...
    public function orderMcAutoNotice(array $body)
    {
        try {
            ...
            $this->errTraceName = 'H5fastPay--orderMcAutoNotice';
    ...
    public function clearfileDownload(array $body)
    {
        try {
            ...
            $this->errTraceName = 'H5fastPay--clearfileDownload';
